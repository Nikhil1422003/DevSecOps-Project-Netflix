...
- Clone the repository that mentioned below
    
    ```bash
    https://github.com/Nikhil1422003/DevSecOps-Project.git
    ```
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/Nikhil1422003/DevSecOps-Project.git'
            }
        }
...
- To securely handle DockerHub credentials in your Jenkins pipeline, follow these steps:
  ...
  Now, I have installed the Dependency-Check plugin, configured the tool, and added Docker-related plugins along with My DockerHub credentials in Jenkins. Then proceed with configuring my Jenkins 
  pipeline to include these tools and credentials in your CI/CD process.
...
pipeline{
    ...
    stages {
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag netflix challanikhil48647/netflix:latest "
                       sh "docker push challanikhil48647/netflix:latest "
                    }
                }
            }
        }
        stage("TRIVY"){
            steps{
                sh "trivy image challanikhil48647/netflix:latest > trivyimage.txt" 
            }
        }
        stage('Deploy to container'){
            steps{
                sh 'docker run -d --name netflix -p 8081:80 challanikhil48647/netflix:latest'
            }
        }
    }
}
...
I Got docker login failed error To rectify this i used below commands on my server
